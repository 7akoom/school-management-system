...
<div class="box bb-3 border-warning">
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('upload/spsschool.png') }}" style="width: 120px; height: 100px;">			
  		</div>
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>Syrian Private School</strong></h4>
  			<h6><strong>Damascus</strong></h6>
  			<h5><strong><u><i>Mazzeh</i></u></strong></h5>
